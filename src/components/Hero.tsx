...
export default function Hero({ onOpenApply }: { onOpenApply: () => void }) {
  ...
  const slides: HeroSlide[] = [
    ...
    {
      id: 'slide-3',
      badge: '★ FRONT OFFICE & HOTEL ADMINISTRATION',
      title: '5-Star Front Office & Opera PMS Training',
      synopsis: 'Master real-time Opera PMS check-in terminals, VIP guest relations, resort yield management, and international hotel operations.',
      image: '/images/frontoffice_dept.png',
    },
    {
      id: 'slide-4',
      badge: '★ WOMEN EMPOWERMENT SCHOLARSHIP',
      title: 'Empowering Female Leaders in Luxury Hospitality',
      synopsis: 'Exclusive 30% Fee Discount for female students, preparing future managers for luxury resorts, airlines, cruise lines, and fine dining establishments worldwide.',
